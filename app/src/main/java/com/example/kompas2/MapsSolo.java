...
import com.example.kompas2.databinding.ActivityMapsSoloBinding;
...
public class MapsSolo extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng capital = new LatLng( -7.573822501114289, 110.82462003940431);
        mMap.addMarker(new MarkerOptions().position(country).title("Indonesia"));
        mMap.addMarker(new MarkerOptions().position(capital).icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_YELLOW)).title("Surakarta"));
