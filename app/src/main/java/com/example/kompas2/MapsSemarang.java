...
import com.example.kompas2.databinding.ActivityMapsSemarangBinding;

public class MapsSemarang extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private ActivityMapsSemarangBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Maps");
        binding = ActivityMapsSemarangBinding.inflate(getLayoutInflater());
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng capital = new LatLng( -7.003938658748518, 110.44075050391817);
        mMap.addMarker(new MarkerOptions().position(country).title("Indonesia"));
        mMap.addMarker(new MarkerOptions().position(capital).icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_YELLOW)).title("Semarang"));
